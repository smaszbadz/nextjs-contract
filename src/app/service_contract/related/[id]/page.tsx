...
import Service_Contract_Related_Page from "./Service_Contract_Related_Page";
...
export default async function Page({ params }: Props) {
    ...
    if (userRole != 'ADMIN' && service.createdID != userID) {
        return <AccessDenied type={"[Related Function]"} />
    }

    return <Service_Contract_Related_Page service={service} />
}